...
data_path = 'C:/Users/Sumit Negi/Documents/Python Scripts/facial recognition/facedata/'
...
while True:
    ...
    try:
        ...
        cv2.putText(image, display_string, (100, 120), cv2.FONT_HERSHEY_COMPLEX, 1, (150, 200, 255), 2)
